...
public class JpegConst : Object
{
	internal static int[] ___003C_003EnaturalOrder;

	internal static VLC ___003C_003EYDC_DEFAULT;

	internal static VLC ___003C_003EYAC_DEFAULT;

	internal static VLC ___003C_003ECDC_DEFAULT;

	internal static VLC ___003C_003ECAC_DEFAULT;

	[Modifiers(Modifiers.Private | Modifiers.Static | Modifiers.Final)]
	private static string[] names;

	public const int SOF0 = 192;

	public const int SOF1 = 193;

	public const int SOF2 = 194;

	public const int SOF3 = 195;

	public const int DHT = 196;

	public const int DQT = 219;

	public const int SOS = 218;

	public const int EOI = 217;

	public const int SOI = 216;

	public const int APP0 = 224;

	public const int APP1 = 225;

	public const int APP2 = 226;

	public const int APP3 = 227;

	public const int APP4 = 228;

	public const int APP5 = 229;

	public const int APP6 = 230;

	public const int APP7 = 231;

	public const int APP8 = 232;

	public const int APP9 = 233;

	public const int APPA = 234;

	public const int APPB = 235;

	public const int APPC = 236;

	public const int APPD = 237;

	public const int APPE = 238;

	public const int APPF = 239;

	public const int RST0 = 208;

	public const int RST1 = 209;

	public const int RST2 = 210;

	public const int RST3 = 211;

	public const int RST4 = 212;

	public const int RST5 = 213;

	public const int RST6 = 214;

	public const int RST7 = 215;

	public const int COM = 254;

	public const int DRI = 221;
	...
	public static int[] naturalOrder
	{
		[HideFromJava]
		get
		{
			return ___003C_003EnaturalOrder;
		}
	}
	...
	public static VLC YDC_DEFAULT
	{
		...
		get
		{
			return ___003C_003EYDC_DEFAULT;
		}
	}
	...
	public static VLC YAC_DEFAULT
	{
		...
		get
		{
			return ___003C_003EYAC_DEFAULT;
		}
	}
	...
	public static VLC CDC_DEFAULT
	{
		...
		get
		{
			return ___003C_003ECDC_DEFAULT;
		}
	}
	...
	public static VLC CAC_DEFAULT
	{
		...
		get
		{
			return ___003C_003ECAC_DEFAULT;
		}
	}
	...
	static JpegConst()
	{
		___003C_003EnaturalOrder = new int[64]
		{
		...
		___003C_003EYDC_DEFAULT = bldr1.getVLC();
		...
		___003C_003ECDC_DEFAULT = bldr2.getVLC();
		...
		___003C_003EYAC_DEFAULT = bldr3.getVLC();
		...
		___003C_003ECAC_DEFAULT = bldr4.getVLC();
		names = new string[256];
		for (int i = 0; i < (nint)names.LongLength; i++)
		{
			names[i] = new StringBuilder().append("(0x").append(Integer.toHexString(i)).append(")")
				.toString();
		}
		names[192] = "SOF0";
		names[193] = "SOF1";
		...
		DEFAULT_QUANT_CHROMA = new int[64]
		{
