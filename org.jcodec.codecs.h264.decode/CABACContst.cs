...
public class CABACContst : Object
{
	public static int[] cabac_context_init_I_A;

	public static int[] cabac_context_init_I_B;
	...
	static CABACContst()
	{
		cabac_context_init_I_A = new int[1024]
		{
		...
		cabac_context_init_I_B = new int[1024]
		{
		...
		cabac_context_init_PB_A = new int[3][]
		{
			new int[1024]
			{
				20, 2, 3, 20, 2, 3, -28, -23, -6, -1,
		...
		cabac_context_init_PB_B = new int[3][]
		{
			new int[1024]
			{
				-15, 54, 74, -15, 54, 74, 127, 104, 53, 54,
