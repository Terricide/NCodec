...
public class Yuv422pToYuv420pHiBD : Object, TransformHiBD
{
	private int shiftUp;
	...
	{
		159, 129, 98, 101, 106, 103, 49, 175, 229, 60,
		231, 70
	})]
	...
	[LineNumberTable(new byte[] { 159, 131, 162, 104, 48, 167 })]
	...
	[LineNumberTable(new byte[] { 159, 132, 98, 104, 48, 167 })]
	...
	[LineNumberTable(new byte[]
	{
		159, 136, 66, 111, 119, 127, 4, 159, 4, 111,
