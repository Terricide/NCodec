...
public class Yuv420jToRgb : Object, Transform
{
	...
	{
		159, 122, 97, 74, 108, 112, 120, 144, 106, 106,
		106, 119, 121, 121
	})]
	public static void YUVJtoRGB(byte y, byte cb, byte cr, byte[] data, int off)
	{
		...
		int g = y_ + add_g >> 10;
		int b = y_ + add_b >> 10;
		data[off] = (byte)(sbyte)MathUtil.clip(r - 128, -128, 127);
		data[off + 1] = (byte)(sbyte)MathUtil.clip(g - 128, -128, 127);
		data[off + 2] = (byte)(sbyte)MathUtil.clip(b - 128, -128, 127);
	}
	...
	[LineNumberTable(new byte[]
	{
		159, 137, 66, 105, 105, 105, 137, 103, 105, 115,
		115, 103, 125, 159, 2, 127, 4, 191, 8, 231,
		55, 236, 75, 110, 139, 125, 159, 4, 167, 234,
		43, 236, 87, 110, 115, 103, 125, 159, 2, 231,
	...
	[LineNumberTable(new byte[] { 159, 124, 162, 116, 116, 117 })]
	static Yuv420jToRgb()
	{
